DB_PATH = '/home/dags/Lead_scoring_data_pipeline/' #/home/airflow/dags/Lead_scoring_data_pipeline/
DB_FILE_NAME = 'lead_scoring_data_cleaning.db'

DB_FILE_MLFLOW = 'Lead_scoring_mlflow_production.db'

TRACKING_URI = "http://0.0.0.0:6006" #6006/6008/6009
EXPERIMENT = "Lead_scoring_mlflow_production"

DATA_DIRECTORY = '/home/dags/Lead_scoring_data_pipeline/data/'
LEAD_SCORING_FILE = 'leadscoring' #.csv file
...
#ONE_HOT_ENCODED_FEATURES = ##['city_tier','total_leads_droppped','referred_lead','app_complete_flag','assistance_interaction','career_interaction','payme#nt_interaction','social_interaction','syllabus_interaction']

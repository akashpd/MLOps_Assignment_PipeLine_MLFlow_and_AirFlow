...
#import Lead_scoring_inference_pipeline.constants
from Lead_scoring_inference_pipeline.constants import *
# for ref from Lead_scoring_training_pipeline.constants import *
...
def encode_features():
    ...
    ''' db_path, db_file_name, one_hot_encoded_features, features_to_encode '''
    #input_data = __read_input_data(db_path, db_file_name, 'interactions_mapped')loaded_data
    input_data = __read_input_data(db_path, db_file_name, 'loaded_data')
...
def get_models_prediction():
    ...
    SAMPLE USAGE
        load_model()
    '''
    ''' db_path, db_file_name, model_name, model_stage, tracking_uri'''
...
def prediction_ratio_check():
    ...
    ''' db_path, db_file_name, script_output '''
...
def input_features_check():
    ...
    ''' db_path, db_file_name, one_hot_encoded_features '''
